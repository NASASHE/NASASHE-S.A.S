...
* limitations under the License.
*/
function mb(e){e=cc(e,$);let t=cc(e.firestore,hy);return $v(_y(t),e._key).then((n=>wb(t,e,n)))}fb._jsonSchemaVersion=`firestore/querySnapshot/1.0`,fb._jsonSchema={type:I(`string`,fb._jsonSchemaVersion),bundleSource:I(`string`,`QuerySnapshot`),bundleName:I(`string`),bundle:I(`string`)};var hb=class extends ob{constructor(e){super(),this.firestore=e}convertBytes(e){return new yy(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new $(this.firestore,null,t)}};function gb(e){e=cc(e,sy);let t=cc(e.firestore,hy),n=_y(t),r=new hb(t);return Jy(e._query),ey(n,e._query).then((n=>new fb(t,r,e,n)))}function _b(e){e=cc(e,sy);let t=cc(e.firestore,hy),n=_y(t),r=new hb(t);return ey(n,e._query,{source:`server`}).then((n=>new fb(t,r,e,n)))}function vb(e,t,n){e=cc(e,$);let r=cc(e.firestore,hy),i=sb(e.converter,t,n);return Cb(r,[jy(Ay(r),`setDoc`,e._key,i,e.converter!==null,n).toMutation(e._key,J.none())])}function yb(e,t,n,...r){e=cc(e,$);let i=cc(e.firestore,hy),a=Ay(i),o;return o=typeof(t=v(t))==`string`||t instanceof by?Py(a,`updateDoc`,e._key,t,n,r):Ny(a,`updateDoc`,e._key,t),Cb(i,[o.toMutation(e._key,J.exists(!0))])}function bb(e){return Cb(cc(e.firestore,hy),[new Kf(e._key,J.none())])}function xb(e,t){let n=cc(e.firestore,hy),r=uy(e),i=sb(e.converter,t);return Cb(n,[jy(Ay(e.firestore),`addDoc`,r._key,i,e.converter!==null,{}).toMutation(r._key,J.exists(!1))]).then((()=>r))}function Sb(e,...t){e=v(e);let n={includeMetadataChanges:!1,source:`default`},r=0;typeof t[r]!=`object`||my(t[r])||(n=t[r++]);let i={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(my(t[r])){let e=t[r];t[r]=e.next?.bind(e),t[r+1]=e.error?.bind(e),t[r+2]=e.complete?.bind(e)}let a,o,s;if(e instanceof $)o=cc(e.firestore,hy),s=Bd(e._key.path),a={next:n=>{t[r]&&t[r](wb(o,e,n))},error:t[r+1],complete:t[r+2]};else{let n=cc(e,sy);o=cc(n.firestore,hy),s=n._query;let i=new hb(o);a={next:e=>{t[r]&&t[r](new fb(o,i,n,e))},error:t[r+1],complete:t[r+2]},Jy(e._query)}return function(e,t,n,r){let i=new Vv(r),a=new Y_(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>H_(await Qv(e),a))),()=>{i.Nu(),e.asyncQueue.enqueueAndForget((async()=>U_(await Qv(e),a)))}}(_y(o),s,i,a)}function Cb(e,t){return function(e,t){let n=new Is;return e.asyncQueue.enqueueAndForget((async()=>lv(await Xv(e),t,n))),n.promise}(_y(e),t)}function wb(e,t,n){let r=n.docs.get(t._key),i=new hb(e);return new ub(e,i,t._key,r,new lb(n.hasPendingWrites,n.fromCache),t.converter)}var Tb=class{constructor(e){let t;this.kind=`persistent`,e?.tabManager?(e.tabManager._initialize(e),t=e.tabManager):(t=kb(void 0),t._initialize(e)),this._onlineComponentProvider=t._onlineComponentProvider,this._offlineComponentProvider=t._offlineComponentProvider}toJSON(){return{kind:this.kind}}};function Eb(e){return new Tb(e)}var Db=class{constructor(e){this.forceOwnership=e,this.kind=`persistentSingleTab`}toJSON(){return{kind:this.kind}}_initialize(e){this._onlineComponentProvider=Bv.provider,this._offlineComponentProvider={build:t=>new Rv(t,e?.cacheSizeBytes,this.forceOwnership)}}},Ob=class{constructor(){this.kind=`PersistentMultipleTab`}toJSON(){return{kind:this.kind}}_initialize(e){this._onlineComponentProvider=Bv.provider,this._offlineComponentProvider={build:t=>new zv(t,e?.cacheSizeBytes)}}};function kb(e){return new Db(e?.forceOwnership)}function Ab(){return new Ob}
/**
* @license
* Copyright 2022 Google LLC
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var jb={maxAttempts:5},Mb=class{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=Ay(e)}set(e,t,n){this._verifyNotCommitted();let r=Nb(e,this._firestore),i=sb(r.converter,t,n),a=jy(this._dataReader,`WriteBatch.set`,r._key,i,r.converter!==null,n);return this._mutations.push(a.toMutation(r._key,J.none())),this}update(e,t,n,...r){this._verifyNotCommitted();let i=Nb(e,this._firestore),a;return a=typeof(t=v(t))==`string`||t instanceof by?Py(this._dataReader,`WriteBatch.update`,i._key,t,n,r):Ny(this._dataReader,`WriteBatch.update`,i._key,t),this._mutations.push(a.toMutation(i._key,J.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=Nb(e,this._firestore);return this._mutations=this._mutations.concat(new Kf(t._key,J.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new M(j.FAILED_PRECONDITION,`A write batch can no longer be used after commit() has been called.`)}};function Nb(e,t){if((e=v(e)).firestore!==t)throw new M(j.INVALID_ARGUMENT,`Provided document reference is from a different Firestore instance.`);return e}
/**
* @license
* Copyright 2020 Google LLC
*
...
* limitations under the License.
*/
var Pb=class{constructor(e,t){this._firestore=e,this._transaction=t,this._dataReader=Ay(e)}get(e){let t=Nb(e,this._firestore),n=new cb(this._firestore);return this._transaction.lookup([t._key]).then((e=>{if(!e||e.length!==1)return O(24041);let r=e[0];if(r.isFoundDocument())return new Gy(this._firestore,n,r.key,r,t.converter);if(r.isNoDocument())return new Gy(this._firestore,n,t._key,null,t.converter);throw O(18433,{doc:r})}))}set(e,t,n){let r=Nb(e,this._firestore),i=sb(r.converter,t,n),a=jy(this._dataReader,`Transaction.set`,r._key,i,r.converter!==null,n);return this._transaction.set(r._key,a),this}update(e,t,n,...r){let i=Nb(e,this._firestore),a;return a=typeof(t=v(t))==`string`||t instanceof by?Py(this._dataReader,`Transaction.update`,i._key,t,n,r):Ny(this._dataReader,`Transaction.update`,i._key,t),this._transaction.update(i._key,a),this}delete(e){let t=Nb(e,this._firestore);return this._transaction.delete(t._key),this}},Fb=class extends Pb{constructor(e,t){super(e,t),this._firestore=e}get(e){let t=Nb(e,this._firestore),n=new hb(this._firestore);return super.get(e).then((e=>new ub(this._firestore,n,t._key,e._document,new lb(!1,!1),t.converter)))}};function Ib(e,t,n){e=cc(e,hy);let r={...jb,...n};return(function(e){if(e.maxAttempts<1)throw new M(j.INVALID_ARGUMENT,`Max attempts must be at least 1`)})(r),function(e,t,n){let r=new Is;return e.asyncQueue.enqueueAndForget((async()=>{let i=await Zv(e);new Uv(e.asyncQueue,i,n,t,r).ju()})),r.promise}(_y(e),(n=>t(new Fb(e,n))),r)}
/**
* @license
* Copyright 2020 Google LLC
*
...
* limitations under the License.
*/
function Lb(e){return _y(e=cc(e,hy)),new Mb(e,(t=>Cb(e,t)))}(function(e,t=!0){(function(e){As=e})(en),Yt(new Me(`firestore`,((e,{instanceIdentifier:n,options:r})=>{let i=e.getProvider(`app`).getImmediate(),a=new hy(new zs(e.getProvider(`auth-internal`)),new Us(i,e.getProvider(`app-check-internal`)),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,[`projectId`]))throw new M(j.INVALID_ARGUMENT,`"projectId" not provided in firebase.initializeApp.`);return new ku(e.options.projectId,t)}(i,n),i);return r={useFetchStreams:t,...r},a._setSettings(r),a}),`PUBLIC`).setMultipleInstances(!0)),rn(Ds,Os,e),rn(Ds,Os,`esm2020`)})();export{Yi as C,Qi as S,tn as T,yb as _,uy as a,Ji as b,_b as c,nb as d,Eb as f,vb as g,Ib as h,bb as i,gy as l,Zy as m,xb as n,mb as o,Ab as p,ly as r,gb as s,L as t,Sb as u,$y as v,$i as w,ds as x,Lb as y};